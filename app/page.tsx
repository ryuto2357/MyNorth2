  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="fixed inset-0 -z-20">
        ...
        <div className="absolute top-1/2 right-1/4 w-96 h-96 bg-gray-300 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-2" />
        <div className="absolute -bottom-8 left-1/2 w-96 h-96 bg-gray-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-4" />
      </div>
        ...
        <div className="max-w-3xl mx-auto text-center space-y-8 animate-fade-in-up">
          <div className="space-y-4">
            <h1 className="text-6xl md:text-7xl font-bold text-gray-900 leading-tight">
              Your Path to <span className="bg-gradient-to-r from-gray-700 to-gray-400 bg-clip-text text-transparent">MyNorth</span>
            </h1>
            <p className="text-xl md:text-2xl text-gray-600 font-light leading-relaxed max-w-2xl mx-auto">
              Eliminate the paralysis between your goals and daily action. Morgan is your personal AI companion designed to break down your dreams into <span className="font-semibold text-gray-700">actionable daily tasks</span>.
            </p>
          </div>
      ...
      <section className="relative z-10 py-24 px-4 bg-gradient-to-b from-transparent to-white/50">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold text-center text-gray-900 mb-16">
            Why Choose <span className="text-gray-700">MyNorth</span>?
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="group card hover:shadow-lg transition-all duration-300 hover:scale-105 hover:-translate-y-2 animate-fade-in-up animation-delay-1">
              <div className="w-14 h-14 bg-gradient-to-br from-gray-500 to-gray-700 rounded-lg flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2 group-hover:text-gray-700 transition-colors">Morgan AI</h3>
            ...
            <div className="group card hover:shadow-lg transition-all duration-300 hover:scale-105 hover:-translate-y-2 animate-fade-in-up animation-delay-2">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2 group-hover:text-gray-700 transition-colors">Constellation</h3>
            ...
            <div className="group card hover:shadow-lg transition-all duration-300 hover:scale-105 hover:-translate-y-2 animate-fade-in-up animation-delay-3">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2 group-hover:text-gray-700 transition-colors">15 Minutes Daily</h3>
      ...
      <div className="fixed bottom-8 right-8 z-40">
        <Link
          href="/onboarding"
          className="w-16 h-16 bg-gradient-to-br from-gray-700 to-gray-700 rounded-full flex items-center justify-center text-white font-bold text-2xl shadow-lg hover:shadow-xl hover:scale-110 transition-all duration-300 hover:from-gray-700 hover:to-gray-800"
          title="Get Started"
        >
          →
        </Link>
